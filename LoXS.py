...
#	filename="right_png_im"+"/"+fil
#	implot=plt.imshow(image_array_r[r_count])
#	#plt.close()
#	plt.savefig(filename)
#	r_count+=1

#implot=plt.imshow(image_array_r[2])
#plt.show(implot)
...
def on_click_button2():
    ...
    if '.' in c2:
        c2 = c2.replace(".","_")
    pol1="right_png_im"+"/"+c1+'.png' 
    pol2="left_png_im"+"/"+c1+'.png'   

    pol1_index.setText(str(photon_energies.index(l3_in)))
    pol2_index.setText(str(photon_energies.index(l3_in)))
    #pol.setText('1')
...
def on_click_button3():
    ...
    if '.' in c4:
        c4 = c4.replace(".","_")
    c3="left_png_im"+"/"+c3+'_L.png' 
    c4="left_png_im"+"/"+c4+'_L.png'
 
    l3_index.setText(str(photon_energies.index(l3_in)))
    l2_index.setText(str(photon_energies.index(l2_in)))
    pol.setText('2')
    label4.setText('Energy (eV) :'+ str(l3_in)+ "@ Polarization 1")
    label5.setText('Energy (eV) :'+ str(l2_in)+"@ Poalrization 1")
    show3(w,c3)
    show4(w,c4)
...
def on_click_button15():
    ...
    if '.' in l2_name:
        l2_name = l2_name.replace(".","_")
    pol2_index.setText(str(photon_energies.index(l2_in)))
